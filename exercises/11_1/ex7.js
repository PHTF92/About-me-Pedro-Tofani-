  ...
  return (
    <div className="row">
      ...
      <div className="col-sm-4">
       ...
       <div className="col-sm-4">
                <Card
                    featureImage="https://miro.medium.com/max/1600/1*OvYjQmX9G7QXZkMYQE-wpQ.jpeg"
                    title="Creating a Simple App With React.js"
                    description="Build a simple task-tracker app from scratch with React"
                    link="https://medium.com/better-programming/creating-a-simple-app-with-react-js-f6aa88998952"
                />
            </div>
      <div className="col-sm-4">
                <Card
                    featureImage="https://tableless.com.br/images/logom.svg"
                    title="O Guia Completo do React e o seu Ecossistema"
                    description="Você ouve falar frequentemente sobre o React mas sabe pouco sobre ele?"
